...
using Xunit;
using Verifier =
    Microsoft.CodeAnalysis.CSharp.Testing.XUnit.CodeFixVerifier<Beeswax.Analyzers.SampleSyntaxAnalyzer,
        Beeswax.Analyzers.SampleCodeFixProvider>;

namespace Beeswax.Analyzers.Tests;
